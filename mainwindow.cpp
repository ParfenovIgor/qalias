...
#ifndef QT_NO_CLIPBOARD
    connect(child->editor, &QPlainTextEdit::copyAvailable, cutAct, &QAction::setEnabled);
    connect(child->editor, &QPlainTextEdit::copyAvailable, copyAct, &QAction::setEnabled);
#endif
